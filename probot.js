...
if (!args) return message.reply('**You must type a word or phrase to send the brodcast**');message.channel.send(`**Are you sure you want to send your podcast?\ nProudcast content:** \` ${args}\``).then(msg => {
msg.react('✅')
.then(() => msg.react('❌'))
.then(() =>msg.react('✅'))
